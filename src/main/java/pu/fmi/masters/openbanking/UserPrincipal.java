...
public class UserPrincipal implements UserDetails {
	 ...
	 * True is returned by default as the application does not implement locking of accounts.
	 */
	@Override
	...
	/**
	 * This method returns the the status of the account's credentials.
	 * True is returned by default as the application does not implement expiration of credentials.
	 */
	@Override
	...
	/**
	 * This method returns the the status of the account.
	 * True is returned by default as the application does not implement account disabling.
	 */
	@Override
